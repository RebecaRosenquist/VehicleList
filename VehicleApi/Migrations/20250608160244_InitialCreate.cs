        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Colur = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CarEquipmentsId = table.Column<int>(type: "int", nullable: false),
                    CarsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarCarEquipment", x => new { x.CarEquipmentsId, x.CarsId });
                    table.ForeignKey(
                        name: "FK_CarCarEquipment_CarEquipments_CarEquipmentsId",
                        column: x => x.CarEquipmentsId,
